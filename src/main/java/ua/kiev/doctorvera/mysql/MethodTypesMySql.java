...
public class MethodTypesMySql extends AbstractMySql<MethodTypes, Integer> {
	...
	@Override
	protected void prepareStatementForInsert(PreparedStatement statement, MethodTypes methodTypes)
	...
	@Override
	protected void prepareStatementForUpdate(PreparedStatement statement, MethodTypes methodTypes)
			throws PersistException {
		try {
			statement.setString(1, methodTypes.getShortName());
			statement.setString(2, methodTypes.getFullName());
	...
	public Collection<MethodTypes> findByName(String name) {
	...
	public Collection<MethodTypes> findByDescription(String description) {
		ArrayList<MethodTypes> methodTypeList = new ArrayList<MethodTypes>();
		try {
